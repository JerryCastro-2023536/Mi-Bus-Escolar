...
export const createPagoSchema = pagoSchema.omit({ id_pago: true });
...
export const registrarPagoSchema = z.object({
	...
	referencia_pago: zUtils.optionalString("referencia_pago"),

	foto_comprobante: zUtils.optionalString("foto_comprobante")
});