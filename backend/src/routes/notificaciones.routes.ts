...
import { deleteNotificacion, getMisNotificaciones, getNotificacionById, getNotificaciones, postNotificaciones, putNotificacion } from "../controllers/notificaciones.controller";
...
router.get("/notificaciones/mias", getMisNotificaciones);
