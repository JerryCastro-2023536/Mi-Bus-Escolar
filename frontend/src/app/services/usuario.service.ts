...
export class UsuarioService {
    ...
    cambiarPassword(id: number, data: { oldPassword: string; newPassword: string }): Observable<ApiResponse<unknown>> {
        return this.crud.update<unknown>(`${this.endpoint}/password`, id, data);
    }
